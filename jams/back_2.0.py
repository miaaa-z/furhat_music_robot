...
def beat_track(infile, outfile):
    ...
    label_a.append(time=0, duration=15, value='happy')
    ...
    label_a.append(time=114, duration=3, value='thoughtful')
    ...
    label_a.append(time=117, duration=7, value='thoughtful')
    ...
    label_a.append(time=124, duration=7, value='happy')
    ...
    jam.annotations.append(label_a)  # add labels
...
if __name__ == '__main__':
    ...
    outfile = '/Users/miaaa/Desktop/music robot/jams/back_2.jams'
